...
class HospitalController extends Controller
{
    ...
    {
        menuSubmenu('hospitals','allHospitals');
    ...
    {
        menuSubmenu('hospitals','createHospitals');
    ...
    public function store(Request $request)
    {
        ...
        $hospital->save();
        return redirect()->route('hospitals.index')->with("success","Hospital Created Successfuly");
    ...
    public function update(Request $request, $id)
    {
        ...
        $hospital->save();
        return redirect()->back()->with("success","Hospital Created Successfuly");
    ...
    public function destroy($id)
    {
        ...
        $hospital->delete();
        return back()->with("success","Hospital Delated Successfuly");
    }
