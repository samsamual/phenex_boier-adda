                        ...
                        <tr class="cart-item" data-cart="{{ $cart->id }}">
                            ...
                            <td class="align-middle">
                                <div class="d-flex align-items-center gap-2 cart-action-wrapper">
                                    <button class="btn btn-sm btn-success minus updateCartItem"
                                    ...
                                    <button class="btn btn-sm btn-success plus updateCartItem"
                                            data-url="{{ route('cartUpdateQty') }}"
                                            data-cart="{{ $cart->id }}"
                                            data-qty="{{ $cart->quantity }}">+</button>
                                </div>
                            </td>
                            <td class="text-end align-middle fw-semibold text-success itemTotalPrice"
...
@if(!$cartItems->isEmpty())
<div class="p-3 border-top bg-success bg-opacity-10 rounded">
    <div class="text-center bg-success text-white rounded py-1 fw-semibold mb-3 small">
