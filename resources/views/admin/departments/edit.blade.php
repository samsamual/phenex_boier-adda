                    ...
                    <div class="row py-2">
                        <div class="col-12 col-md-9 m-auto card p-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name_en') is_invalid @enderror" id="" placeholder="Name" name="name_en" value="{{ $department->name_en }}">
                                @error('name_en')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="excerpt_en" id="" cols="30" rows="5" class="form-control" placeholder="Excerpt">{{ $department->excerpt_en }}</textarea>
                            </div>
