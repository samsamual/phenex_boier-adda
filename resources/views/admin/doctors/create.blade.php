...
@section('title',"Admin Dashboard | Create Doctor")
                    ...
                    <div class="row py-2">
                        <div class="col-12 col-md-12 m-auto card p-5">
                            <div class="form-group">
                                <label for="name_en">Doctor Name</label>
                                <input type="text" class="form-control @error('name_en') is_invalid @enderror" id="" placeholder="Doctor Name" name="name_en" value="{{ old('name_en') }}">
                                @error('name_en')
