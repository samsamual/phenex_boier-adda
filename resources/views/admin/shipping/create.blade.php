                    ...
                    <div class="row py-2">
                        <div class="col-12 col-md-12 m-auto card p-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('location') is_invalid @enderror" id="" placeholder="location" name="location" value="{{ old('location') }}">
                                @error('location')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('price') is_invalid @enderror" id="" placeholder="price" name="price" value="{{ old('price') }}">
                                @error('price')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
